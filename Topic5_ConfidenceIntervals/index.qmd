...
[Use the sampled data to construct a 99% confidence interval for the true average head length of all possums in Australia and New Guinea.]{style="color:#D73F09;"}
:::
:::::
...
*Don't forget to check the sample size conditions before constructing the interval.*
