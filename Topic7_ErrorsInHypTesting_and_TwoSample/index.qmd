...
::: {style="text-align: center"}
[($4-3.5)$]{.fragment style="color:blue;"} [$\pm$]{.fragment style="color:blue;"} [$2.645$]{.fragment style="color:blue;"} [$\sqrt{\frac{1.5^2}{46}+\frac{1^2}{32}}$]{.fragment style="color:blue;"}[$= (-0.248, 1.248)$]{.fragment style="color:blue;"}
:::
...
[$H_0:$]{.fragment style="color:blue;"}[$\mu_A = \mu_B$]{.fragment style="color:blue;"}

 

[$H_0:$]{.fragment style="color:blue;"}[$\mu_A \neq \mu_B$]{.fragment style="color:blue;"}
...
[**Upper one-sided**: $H_A: \mu_1 >\mu _1$]{.fragment fragment-index="4"}
...
[So the null distribution is a]{.fragment style="color:blue;"}[**t distribution with 75.897 degrees of freedom**.]{.fragment style="color:blue;"}
:::
...
[$$t = \frac{4-3}{\sqrt{\frac{1.5^2}{46} + \frac{1^2}{32}}} = 1.766$$]{.fragment style="color:blue;"}
...
[$H_A: \mu_1<\mu_1$]{.fragment fragment-index="2"}
:::
...
[[`2*(1-pt(abs(1.766), 75.897))` = 0.0814]{.fragment}]{.fragment}
