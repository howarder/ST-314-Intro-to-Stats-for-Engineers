...
[📊 In Poll Everywhere, comment on whether you think the means of the populations from which the above three samples came are the same, similar, or significantly different from one another.]{.fragment fragment-index="2"}
::::
...
[📊 Again, in Poll Everywhere, comment on whether you think the means of the populations from which the above three samples came are the same, similar, or significantly different from one another.]{.fragment fragment-index="2"}
::::
