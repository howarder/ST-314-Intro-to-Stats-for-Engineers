...
[📊 In Poll Everywhere, comment on whether you think the means of the populations from which the above three samples came are the same, similar, or significantly different from one another.]{.fragment}
::::
...
[📊 Again, in Poll Everywhere, comment on whether you think the means of the populations from which the above three samples came are the same, similar, or significantly different from one another.]{.fragment}
::::
...
## Example Problem 🚲 🚗 🚶‍♀️ {.smaller}

[Suppose we are interested in determining if there is a significant difference in the average number of hours of sleep students get per night based on whether they bike, drive, or walk to campus. We'll consider a significant result using the $\alpha = 0.05$ significance level.]{.fragment style="color:blue;"}

 

[**Question of interest:** Is there is a difference in the average number of hours of sleep students get per night based on whether they drive, bike, or walk to campus?]{.fragment style="color:blue;"}

 

[**Parameters of interest:**]{.fragment style="color:blue;"}

[$\mu_B$, average amount of sleep for **all** students who bike]{.fragment style="color:blue;"}

[$\mu_D$, average amount of sleep for **all** students who drive]{.fragment style="color:blue;"}

[$\mu_W$, average amount of sleep for **all** students who walk]{.fragment style="color:blue;"}
...
Write the null hypothesis for our [bike, drive, walk example]{style="color:blue;"}.
...
[$H_0: \mu_B = \mu_D = \mu_W$]{.fragment style="color:blue;"}

 

[$H_A:$ At least one transportation group gets a different number of hours of sleep per night, on average, than the others.]{.fragment style="color:blue;"}
...
[Data were collected on 250 randomly selected students. The summary statistics and sampled distributions for these data are shown below.]{style="color:blue;"}
...
::: column
![](transport_graphs.png){fig-alt="Three histograms showing the distributions of sleep per night for bike, drive, and walk samples. The bike and walk distributions are left skewed. The drive distribution is approximately symmetric." fig-align="center"}
:::
:::::

## Participation Question 📊 {.smaller}

::::: columns
::: column
Assess the sample size condition needed to perform an ANOVA F test for our [bike, drive, walk example]{style="color:blue;"}.
...
::::: columns
::: column
Consider the constant variance assumption needed to perform an ANOVA F test. Do you think the condition is met for our [bike, drive, walk example]{style="color:blue;"}? Why or why not?
...
::: fragment
![](f.png){fig-alt="A number line that begins at zero on the left. A mark for F is indicated. Every value to the right of F on the number line is highlighted."}
:::
