...
You decide to set up an experiment to test whether the generator is choosing the Special Cup more often than the other three cups. You play 100 rounds. On each round, you record the number of times the Special Cup was selected for the races.
