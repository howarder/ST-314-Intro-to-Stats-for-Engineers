...
:::::: columns
::: {.column width="45%"}
[3. ]{.fragment}[State the null and alternative hypotheses.]{.fragment .highlight-red}
:::
...
:::::: columns
::: {.column width="45%"}
[4. ]{.fragment}[Using the sampled data and the alternative hypothesis, determine what values would be considered "as or more extreme" than the observed sampled statistic.]{.fragment .highlight-red}
:::
...
::: fragment
![](errors.png){width="75%" fig-alt="Table describing errors in hypothesis testing. Type 1 error occurs when the null hypothesis is rejected in favor of the alternative but the null hypothesis was true. Type 2 error occurs when the null hypothesis is not rejected but the alternative hypothesis was true."}
:::
