...
::::: columns
::: column
[✍️ Describe the relationship between illiteracy rate and life expectancy shown in the [scatterplot]{style="color:red;"} above.]{.fragment}
:::
...
[For every one percent increase in illiteracy rate, average life expectancy is expected to decrease by 1.146 years. ]{.fragment style="color:blue;"}
...
[**Compute the residual for a state that had an illiteracy rate of 1.4% and an average life expectancy of 70.55.**]{.fragment style="color:blue;"}

 

[$$e = 70.55 - 70.577 = -0.027$$]{.fragment style="color:blue;"}
