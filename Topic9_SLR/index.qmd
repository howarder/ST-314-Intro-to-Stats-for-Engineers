...
Answer Question 3 in the classroom tab on Top Hat using the fitted LSRL.
...
Answer Question 4 in the classroom tab on Top Hat using the fitted LSRL.
...
Answer Question 5 in the classroom tab on Top Hat using the fitted LSRL.
...
Answer Question 6 in the classroom tab on Top Hat using the fitted LSRL and corresponding residual plot.
